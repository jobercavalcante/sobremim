...
| T7 | Integrated QA and evidence | integration-executor | gpt-5.6-terra / medium | T2-T6 | DONE | changes requested; reproducibility fix ready for re-review | 57/57 full suite; browser 4/4, full-scroll lazy network, reproducible visual evidence |
| T8 | Complete change-set review | final-reviewer | gpt-5.6-sol / medium | T7 | PENDING | pending | full evidence bundle |
