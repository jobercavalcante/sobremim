...
| T7 | Integrated QA and evidence | integration-executor | gpt-5.6-terra / medium | T2-T6 | DONE | changes requested; deterministic hash verification ready for re-review | 58/58 full suite; browser 4/4, full-scroll lazy network, reproducible visual evidence |
